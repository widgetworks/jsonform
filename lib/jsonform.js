...
var initializeTabs = function (tabs, options) {
  ...
  var enableFields = function ($target, targetIndex) {
     ...
     * these non-visible tabs should be disabled (default behaviour)
     * or should remain enabled.
     */
...
formTree.prototype.initialize = function (formDesc) {
  ...
  var defaultClasses = getDefaultClasses(this.formDesc.isBootstrap2 || jsonform.isBootstrap2);
