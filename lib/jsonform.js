  ...
  'checkboxes':{
    ...
    'childTemplate': function(inner, node) {
      ...
      if (!node.formElement.otherField)
        return inner;
      var template = '<input type="checkbox"<%= value !== undefined && value !== null && value !== "" ? " checked=\'checked\'" : "" %>';
      if (!node.formElement.otherField.novalue) {
      ...
      //if (!node.formElement.otherField.inlinetitle) {
    ...
    'onInsert': function (evt, node) {
      ...
      var $checkbox = node.formElement.otherField.inline ? $(node.el).find('.inline-other-field :checkbox').first() : $(node.el).find('.other-field :checkbox');
