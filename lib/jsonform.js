...
jsonform.elementTypes = {
  ...
  'checkboxes':{
    ...
    'onBeforeRender': function (data, node) {
      ...
      var template = '<% if (!elt.inline) { %><div class="checkbox"><label><% } else { %>' +
        '<label class="checkbox<%= cls.inlineClassSuffix %>"><% } %>' +
        '<input type="checkbox" <% if (checked) { %> checked="checked" <% } %> name="<%= name %>" value="<%= value %>"' +
        '<%= (node.disabled? " disabled" : "")%>' +
        '/><span><%= title %></span></label><%= elt.inline ? "" : "</div>" %>';
  ...
  'advancedfieldset': {
    'template': '<fieldset' +
      '<% if (id) { %> id="<%= id %>"<% } %>' +
      ' class="expandable jsonform-error-<%= keydash %> <%= elt.htmlClass?elt.htmlClass:"" %>" data-jsonform-type="advancedfieldset">' +
  ...
  'authfieldset': {
    'template': '<fieldset' +
      '<% if (id) { %> id="<%= id %>"<% } %>' +
      ' class="expandable jsonform-error-<%= keydash %> <%= elt.htmlClass?elt.htmlClass:"" %>" data-jsonform-type="authfieldset">' +
...
//        console.log(errormarkerclass);
      ...
      $node.find("> div > .jsonform-errortext").text(errors[i].message).show();
    }
  }
